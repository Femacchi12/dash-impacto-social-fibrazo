...
renderSizes=function(){
 ...
 $('#sizeSummary').innerHTML='<article><span>Promedio por sede</span><b>'+fmt(avg)+'</b></article><article><span>Sedes analizadas</span><b>'+fmt(rs.length)+'</b></article><article><span>Institución con más alumnos</span><b>'+(largest?fmt(largest.people)+' alumnos':'0 alumnos')+'</b><small>'+(largest?esc(largest.institution):'Sin resultados')+'</small></article>';
};
